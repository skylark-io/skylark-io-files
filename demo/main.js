...
//           location : "../../../domx/skylark-domx-files/src",
         ...
         {
           name : "skylark-data-collections" ,
           location : "../node_modules/skylark-data-collections/dist/uncompressed/skylark-data-collections",
            main: 'main'
         },
         {
           name : "skylark-io-diskfs" ,
         ...
         {
           name : "skylark-jqueryui-interact",
           location : "../node_modules/skylark-jqueryui-interact/dist/uncompressed/skylark-jqueryui-interact",
           main: 'main'
         }, 
         {
           name : "skylark-jqueryui",
           location : "../node_modules/skylark-jqueryui/dist/uncompressed/skylark-jqueryui",
           main: 'main'
         },  
         {
            name: 'skylark-data-files',
            location : "../src",
...
require(["skylark-jquery"], function ($) {
    require(["skylark-data-files"], function (files) {
        if (window.initPage) {
            window.initPage($,files);
        }
    });
});